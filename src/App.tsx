...
export default function App() {
  // Segurança/UX: como o site é estático, evita “envio falso” de formulário.
  const onContactSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    alert('Obrigado! Este formulário ainda não está integrado. Entre em contato por e-mail.');
  };
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-xl text-slate-600 mb-10 max-w-lg leading-relaxed">
              O IDAPES é uma instituição dedicada à produção de conhecimento e ao fortalecimento de políticas públicas
              para um futuro sustentável.
            </p>
            <div className="flex flex-wrap gap-4">
              <a
                href="#quem-somos"
                className="px-8 py-4 bg-idapes-blue text-white rounded-full font-semibold hover:bg-idapes-dark transition-all shadow-lg shadow-idapes-blue/20 flex items-center gap-2"
              >
                Saiba mais <ChevronRight size={18} />
              </a>
              <a
                href="#contato"
                className="px-8 py-4 border border-slate-200 text-slate-700 rounded-full font-semibold hover:bg-white hover:border-idapes-blue transition-all"
              >
                Fale conosco
              </a>
            </div>
      ...
      <Section id="quem-somos" className="bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg leading-relaxed text-slate-600">
            <p>
              O <strong>Instituto de Desenvolvimento e Apoio ao Ensino e Pesquisa (IDAPES)</strong> é uma associação
              civil sem fins lucrativos, fundada em 2008, com sede em Vitória, Espírito Santo.
            </p>
            <p>
              Atuamos na promoção do ensino, da pesquisa, da capacitação profissional e do desenvolvimento social, por
              meio da realização de projetos, programas e parcerias institucionais.
            </p>
            <p>
              Com atuação em âmbito local, regional e nacional, o IDAPES desenvolve iniciativas voltadas à produção e à
              difusão do conhecimento, ao fortalecimento de políticas públicas e à promoção do desenvolvimento
              sustentável.
            </p>
          </div>
        </div>
      ...
      <Section id="missao" className="bg-slate-50">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto">
            Nossa base estratégica é construída sobre o compromisso com a ética e a transformação social.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <motion.div key={item.title} whileHover={{ y: -10 }} className="bg-white p-10 rounded-3xl shadow-sm border border-slate-100">
              <div className="w-16 h-16 bg-idapes-blue/5 rounded-2xl flex items-center justify-center mb-6">{item.icon}</div>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/3">
            ...
            <p className="text-lg text-slate-600 mb-8">
              O IDAPES atua de forma transversal em diferentes áreas, desenvolvendo projetos e ações que articulam
              ensino, pesquisa e desenvolvimento social.
            </p>
          ...
          <div className="lg:w-2/3 grid sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={area.title} className="p-8 rounded-2xl border border-slate-100 hover:border-idapes-blue/30 hover:shadow-lg transition-all group">
                <div className="text-idapes-blue mb-4 group-hover:scale-110 transition-transform inline-block">{area.icon}</div>
      ...
      <Section id="projetos" className="bg-idapes-dark text-white">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 max-w-3xl mx-auto text-lg">
            Desenvolvemos iniciativas estruturadas de acordo com as demandas sociais e territoriais, observando critérios
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <p className="text-slate-400 leading-relaxed italic">
              "Os projetos são estruturados de acordo com as demandas sociais, institucionais e territoriais, observando
              critérios de impacto social, viabilidade técnica e sustentabilidade."
            </p>
          </div>

          <div className="relative group overflow-hidden rounded-3xl">
            {/* OBS: imagem externa. Para manter segurança com CSP, vamos liberar images.unsplash.com no index.html no próximo passo */}
            <img
      ...
      <Section id="contato" className="bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <form
              className="space-y-4 bg-slate-50 p-8 rounded-3xl border border-slate-100"
            ...
            >
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-idapes-blue focus:ring-2 focus:ring-idapes-blue/20 outline-none transition-all"
              ...
              <button
                type="submit"
                className="w-full py-4 bg-idapes-blue text-white rounded-xl font-bold hover:bg-idapes-dark transition-all shadow-lg shadow-idapes-blue/20"
              >
                Enviar Mensagem
              </button>
              <p className="text-xs text-slate-500 text-center pt-1">
                *Formulário demonstrativo. Para contato imediato, use o e-mail acima.
              </p>
            </form>
          </div>
        </div>
